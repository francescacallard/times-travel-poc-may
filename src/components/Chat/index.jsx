  ...
  const handleSubmit = async (event) => {
    ...
    const systemPrompt = {
      ...
      **Details**
      ...
      Seven nights’ B&B from £895pp, including flights and transfers, departing on April 23 (sovereign.com)" Please provide the response in the following JSON format using double quotes for both property names and values, with no other text at all:
